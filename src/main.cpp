...
void setup() {
    ...
    blindManager->addBlind(19, 18, (int)EEPROM::readUInt("steps_0"), 17650, 0, secrets.sinric.right_blinds_id);
    blindManager->addBlind(26, 27, (int)EEPROM::readUInt("steps_1"), 17650, 0, secrets.sinric.left_blinds_id);
